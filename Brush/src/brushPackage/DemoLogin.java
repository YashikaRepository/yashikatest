...
WebDriver driver = new FirefoxDriver();
		...
		driver.findElement(By.id("stNumber")).sendKeys("4505");
		...
		//Enter Studio Name 
		driver.findElement(By.id("stName")).sendKeys("SoitT Magnifique");
		//IMloder1
		...
		driver.findElement(By.xpath("//*[@id=\"slug\"]")).sendKeys("beautyY");
		//WebElement uploadElement = driver.findElement(By.id("img-upload1"));
		...
		driver.findElement(By.xpath("//*[@id=\"cke_1_bottom\"]")).sendKeys("YASHIKAPATODIA27@ICLOUD.COM");
		
		//*[@id="cke_elementspath_88_0"]
